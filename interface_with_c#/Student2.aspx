<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student2.aspx.cs" Inherits="MichaelPart.Student2" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="Information" runat="server" Text="View My Information" Height="54px" Width="376px" OnClick="Information_Click" />
            ...
            <asp:Button ID="Button1" runat="server" Text="View My Courses" Height="54px" Width="376px" OnClick="Courses_Click" />
            ...
            <asp:Button ID="AddPhone" runat="server" Text="Add Phone Number" OnClick="AddPhone_Click" font-weight ="bold"   />
