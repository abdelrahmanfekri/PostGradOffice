<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment.aspx.cs" Inherits="MichaelPart.comment" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <br />
            comment</div>
        <asp:TextBox ID="TextBox1" runat="server" required = "required" Height="17px" Width="155px"></asp:TextBox>
        <br />
        ...
        <asp:TextBox ID="TextBox2" runat="server" required = "required" pattern = "[0-9]{3}]" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
        <br />
